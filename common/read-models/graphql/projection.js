// @flow
import {STORY_COMMENTED, STORY_CREATED, STORY_UNVOTED, STORY_UPVOTED, USER_CREATED} from '../../events'
import type {
  Event, StoryCommented, StoryCreated, StoryUnvoted, StoryUpvoted,
  UserCreated
...
export default {
  ...
  [STORY_UPVOTED]: async (
    ...
    await stories.update({ id: aggregateId }, {
      ...storyById,
