    ...
    return <div>
        <div className="Items">
            <ol className="Items__list" start="1">
                ...
                <li className="ListItem"><ItemComponent id="3" title="Show HN: Transformation Invariant Reverse Image Search" link="https://pippy360.github.io/transformationInvariantImageSearch/" user="pippy360" date={new Date()} score={15} commentCount={3} newCommentCount={0} /></li>
                <li className="ListItem"><ItemComponent id="4" title="Launch HN: CocuSocial (YC S17) – Marketplace for cooking classes at restaurants" link="/item?id=14971205" user="ys1715" date={new Date()} score={47} commentCount={23} newCommentCount={1} /></li>
                <li className="ListItem"><ItemComponent id="5" title="Ask HN: What are real Ruby on Rails alternatives in 2017?" link="/item?id=14974767" user="rubyfan" date={new Date()} score={18} commentCount={31} newCommentCount={0} /></li>
